...
namespace Lavery.Tools.DBLibrary
{
    public class CTable : CPersisentObject
    {
        ...
        protected CTable(ConnectionPoolDatabases<IGenericConnection> pWithConnFactory, String sWithSchema, String sWithName) :
        ...
        protected CTable(ConnectionPoolDatabases<IGenericConnection> pWithConnFactory) :
