...
namespace Lavery.Tools
{
    public class assemblyLoaderHelper : MarshalByRefObject, IDisposable
    {
        ...
        ReflectionTools oReflectionTools;
        ...
        public ReflectionTools OReflectionTools { get => oReflectionTools; }
        public object OClassInstance { get => oClassInstance; set => oClassInstance = value; }
        ...
        public void loadAssembly(string path, String sAssemblyname)
        {
            try
            {
                ...
                this.oReflectionTools = new ReflectionTools();
            }
            catch (Exception ex)
            {
                throw (ex);
        ...
        public Object ExecuteMethodAndReturnObject(String methodName, Object[] args)
        {
            ...
            try
            {
                if (OClassInstance == default(Object))
                    throw (new Exception("Object not created..."));
                // Dynamically Invoke the method
                oRet = MyType.InvokeMember(methodName,
                    BindingFlags.Default | BindingFlags.InvokeMethod,
                        null,
                        OClassInstance,
                        args);
