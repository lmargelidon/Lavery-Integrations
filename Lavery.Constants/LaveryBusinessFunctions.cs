...
namespace Lavery.Constants
{
    abstract public  class LaveryBusinessFunctions
    {
        ...
        {
            None, Start, Stop,Initialize, CollectExistingFile, PerformEntry, Terminate, CatchNotification, InsertAbsenceRequest, UpdateAbsenceRequest,DeleteAbsenceRequest
        }
