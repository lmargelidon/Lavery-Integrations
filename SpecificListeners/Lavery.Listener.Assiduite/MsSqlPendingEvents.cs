...
{
    public class MsSqlPendingEvents : ListenerAssiduityBase
    {
        ...
        public MsSqlPendingEvents(connectionFactory oConnectionFactory, String SPrefixeName, Guid oGuid) : base(oConnectionFactory) 
        {
            try
            {
        ...
        private void Changed(object sender, RecordChangedEventArgs<TimeCardPending> e)
        {
            ...
            TimeCardPending oTS = new TimeCardPending();
            if (e.ChangeType == ChangeType.Insert)
            {
                TimeCardPending changedEntity = e.Entity;
