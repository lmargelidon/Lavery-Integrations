...
{
    /// <summary>
    /// Represents a single matter object.
    /// </summary>
    [DataContract]
    public partial class E3EAPIMatterModelsMatter :  IEquatable<E3EAPIMatterModelsMatter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPIMatterModelsMatter" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPIMatterModelsMatter {\n");
        ...
        {
            return this.Equals(input as E3EAPIMatterModelsMatter);
        }

        /// <summary>
        /// Returns true if E3EAPIMatterModelsMatter instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPIMatterModelsMatter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPIMatterModelsMatter input)
        {
            if (input == null)
                return false;
