...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class E3EAPICostModelsCostCard :  IEquatable<E3EAPICostModelsCostCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPICostModelsCostCard" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPICostModelsCostCard {\n");
        ...
        {
            return this.Equals(input as E3EAPICostModelsCostCard);
        }

        /// <summary>
        /// Returns true if E3EAPICostModelsCostCard instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPICostModelsCostCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPICostModelsCostCard input)
        {
            if (input == null)
                return false;
