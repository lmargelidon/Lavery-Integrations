...
{
    /// <summary>
    /// Contains parameters to make a request for both posted and pendning timecards.
    /// </summary>
    [DataContract]
    public partial class E3EAPITimeModelsTimecardGetRequest :  IEquatable<E3EAPITimeModelsTimecardGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPITimeModelsTimecardGetRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPITimeModelsTimecardGetRequest {\n");
        ...
        {
            return this.Equals(input as E3EAPITimeModelsTimecardGetRequest);
        }

        /// <summary>
        /// Returns true if E3EAPITimeModelsTimecardGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPITimeModelsTimecardGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPITimeModelsTimecardGetRequest input)
        {
            if (input == null)
                return false;
