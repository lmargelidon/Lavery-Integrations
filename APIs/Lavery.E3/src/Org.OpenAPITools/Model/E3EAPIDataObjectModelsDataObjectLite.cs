...
{
    /// <summary>
    /// Represents 3E data object and is serializable to JSON. Roughly equivalent to the E3E.API.Data.Models.DataRow class.
    /// </summary>
    [DataContract]
    public partial class E3EAPIDataObjectModelsDataObjectLite :  IEquatable<E3EAPIDataObjectModelsDataObjectLite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPIDataObjectModelsDataObjectLite" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPIDataObjectModelsDataObjectLite {\n");
        ...
        {
            return this.Equals(input as E3EAPIDataObjectModelsDataObjectLite);
        }

        /// <summary>
        /// Returns true if E3EAPIDataObjectModelsDataObjectLite instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPIDataObjectModelsDataObjectLite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPIDataObjectModelsDataObjectLite input)
        {
            if (input == null)
                return false;
