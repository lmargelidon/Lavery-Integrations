...
{
    /// <summary>
    /// Represents a single RelatedParty object.
    /// </summary>
    [DataContract]
    public partial class E3EAPIRelatedPartyModelsRelatedParty :  IEquatable<E3EAPIRelatedPartyModelsRelatedParty>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPIRelatedPartyModelsRelatedParty" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPIRelatedPartyModelsRelatedParty {\n");
        ...
        {
            return this.Equals(input as E3EAPIRelatedPartyModelsRelatedParty);
        }

        /// <summary>
        /// Returns true if E3EAPIRelatedPartyModelsRelatedParty instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPIRelatedPartyModelsRelatedParty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPIRelatedPartyModelsRelatedParty input)
        {
            if (input == null)
                return false;
