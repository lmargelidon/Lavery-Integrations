...
{
    /// <summary>
    /// Represents a single Timecard or TimecardPending object.
    /// </summary>
    [DataContract]
    public partial class E3EAPITimeModelsTimecard :  IEquatable<E3EAPITimeModelsTimecard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPITimeModelsTimecard" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPITimeModelsTimecard {\n");
        ...
        {
            return this.Equals(input as E3EAPITimeModelsTimecard);
        }

        /// <summary>
        /// Returns true if E3EAPITimeModelsTimecard instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPITimeModelsTimecard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPITimeModelsTimecard input)
        {
            if (input == null)
                return false;
