...
{
    /// <summary>
    /// Represents a single TempMatter object.
    /// </summary>
    [DataContract]
    public partial class E3EAPITempMatterModelsTempMatter :  IEquatable<E3EAPITempMatterModelsTempMatter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPITempMatterModelsTempMatter" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPITempMatterModelsTempMatter {\n");
        ...
        {
            return this.Equals(input as E3EAPITempMatterModelsTempMatter);
        }

        /// <summary>
        /// Returns true if E3EAPITempMatterModelsTempMatter instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPITempMatterModelsTempMatter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPITempMatterModelsTempMatter input)
        {
            if (input == null)
                return false;
