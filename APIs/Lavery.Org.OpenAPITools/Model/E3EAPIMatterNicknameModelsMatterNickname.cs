...
{
    /// <summary>
    /// Represents a single matter nickname object.
    /// </summary>
    [DataContract]
    public partial class E3EAPIMatterNicknameModelsMatterNickname :  IEquatable<E3EAPIMatterNicknameModelsMatterNickname>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPIMatterNicknameModelsMatterNickname" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPIMatterNicknameModelsMatterNickname {\n");
        ...
        {
            return this.Equals(input as E3EAPIMatterNicknameModelsMatterNickname);
        }

        /// <summary>
        /// Returns true if E3EAPIMatterNicknameModelsMatterNickname instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPIMatterNicknameModelsMatterNickname to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPIMatterNicknameModelsMatterNickname input)
        {
            if (input == null)
                return false;
