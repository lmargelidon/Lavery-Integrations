...
{
    /// <summary>
    /// Represents a single Entity object.
    /// </summary>
    [DataContract]
    public partial class E3EAPIEntityModelsEntity :  IEquatable<E3EAPIEntityModelsEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="E3EAPIEntityModelsEntity" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class E3EAPIEntityModelsEntity {\n");
        ...
        {
            return this.Equals(input as E3EAPIEntityModelsEntity);
        }

        /// <summary>
        /// Returns true if E3EAPIEntityModelsEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of E3EAPIEntityModelsEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(E3EAPIEntityModelsEntity input)
        {
            if (input == null)
                return false;
