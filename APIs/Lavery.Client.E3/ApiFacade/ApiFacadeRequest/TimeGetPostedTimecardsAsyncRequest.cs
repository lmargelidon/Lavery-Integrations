...
{   
    [DataContract]
    public class TimeGetPostedTimecardsAsyncRequest : Object
    {
          [DataMember]
          ...
          [DataMember]
            public List<Guid> timecardID { get; set; }
          [DataMember]
            public Int32 timeIndex { get; set; }
          [DataMember]
        ...
        public void initRequest()
        {
          ...
          timecardID = default(List<Guid>);
          timeIndex = default(Int32);
